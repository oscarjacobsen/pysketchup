...
- <b>key: \ref LOExportOption_OutputResolution, value: Int32</b>\n
  Output resolution for images (including raster models). Must be one of the
  values of the \ref LOImageResolution enum. Defaults to the document's current
  output resolution setting (see \ref LOPageInfoGetOutputResolution).
...
- \ref SU_ERROR_OUT_OF_RANGE if the \ref LOExportOption_OutputResolution option
  specifies a value that is out of range
